...
## Codepipeline Role Policy Documents
data "aws_iam_policy_document" "role_policy_codepipeline_role" {
  statement {
    sid    = "AllowS3Actions"
    effect = "Allow"
    actions = [
...
# Codebuild Role Policy Documents
data "aws_iam_policy_document" "role_policy_codebuild_role" {
  statement {
    sid    = "AllowS3Actions"
    effect = "Allow"
    actions = [
