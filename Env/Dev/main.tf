...
module "codebuild_role_policy" {
  ...
  code_build_projects      = ["*"]
  code_commit_repositories = ["arn:aws:codecommit:ap-southeast-2:048102882581:code-commit-repo-test-app"]
...
module "codebuild_server_app" {
  ...
  git_source = {
    git_source_type    = "CODECOMMIT"
    git_repository_url = "https://git-codecommit.ap-southeast-2.amazonaws.com/v1/repos/code-commit-repo-test-app"
  }
...
module "codepipeline_server_app" {
  ...
  git_repository_name = "code-commit-repo-test-app"
